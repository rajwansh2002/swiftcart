...
<body>
    ...
    // require ('header.php');
    // assume you have a session variable to check if user is logged in
if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == true) {
    // user is logged in, show logged in header
    $header = 'header2.php';
  } else {
    // user is not logged in, show logged out header
    $header = 'header.php';
  }
  require_once($header);
  ...
  echo "<h2>Trending</h2>";
    ...
    $stmt_trending = $pdo->query("SELECT * FROM products ORDER BY RAND() LIMIT 25");
    $trending_products = $stmt_trending->fetchAll(PDO::FETCH_ASSOC);
